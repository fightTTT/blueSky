...
StickHuman::StickHuman(VECTOR2 pos, VECTOR2 offset, PAD_ID id, DIR charaDir) : Character(offset)
{
	...
	case 0:
		...
		AddAnim("ïSóÙãr", 0, 0, 18, 4, false, 0, 0);
		spAttackAnimName[1] = "ïSóÙãr";
		...
		AddAnim("è∏ó≥", 0, 0, 16, 4, false, 0, 0);
	...
	case 5:
		characterName = "ñ_êlä‘_â©";
		break;

	case 6:
		// ÉsÉìÉNÇÃó\íË
		characterName = "ñ_êlä‘";
		AddAnim("îgìÆ", 0, 0, 11, 4, false, 0, 0);
		spAttackAnimName[0] = "îgìÆ";
		spAttackAnimFileName[0] = "hadou";
		spAttackType[0] = SKILL_TYPE_PUNCH;
		animAttributeTbl["îgìÆ"][0] = ANIM_ATTRIBUTE_STAND;
		...
		AddAnim("ê˘ïóãr", 0, 0, 4, 4, true, 0, 0);
